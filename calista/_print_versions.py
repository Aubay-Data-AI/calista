# All of this code are adapted from the pandas project:
# Original Source: https://github.com/pandas-dev/pandas
# File: https://github.com/pandas-dev/pandas/blob/main/pandas/util/_print_versions.py
